...
function DashboardContent() {
  ...
  const tabClass = (t: Tab) =>
    `px-5 py-3 text-sm font-semibold border-b-2 transition-all whitespace-nowrap cursor-pointer ${
      tab === t ? "border-[#d4a373] text-[#d4a373]" : "border-transparent text-gray-500 hover:text-white"
    }`;
          ...
          <div className="max-w-lg space-y-8">
            ...
            <div className="pt-4 border-t border-white/5">
              ...
              <button onClick={deleteAccount}
                className="border border-red-500/40 text-red-400 hover:bg-red-500/10 px-6 py-2.5 text-xs font-semibold uppercase tracking-widest rounded-xl transition">
                Delete My Account
              </button>
            </div>
          </div>
